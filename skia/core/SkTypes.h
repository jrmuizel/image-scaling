...
*/
SK_API inline void* sk_malloc_flags(size_t size, unsigned flags) { return malloc(size); }
/** Same as sk_malloc(), but hard coded to pass SK_MALLOC_THROW as the flag
*/
SK_API inline void* sk_malloc_throw(size_t size) { return malloc(size); }
...
*/
SK_API static inline void sk_free(void*a) { return free(a); }
